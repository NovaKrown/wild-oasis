...
export const cabins = [
  ...
  {
    name: "K̵̪͓̓̽͘͜l̸͔͇͕̀̚͠a̵̠̘͕̿͐͝á̴̞͇̻̚t̵̢̻̺̔͋͝u̴͚̦̽͝͝ B̵͚̟͓͒̒a̸̟͙͒̓͘r̵̫̻̝͛̿̓a̵̡̦͉̐́̿d̴͓̙̠̾̕͝a̵̢̺̺̔̿͠ N̴͚͔̪͛̐͝i̴̻̦͎͘̚͝k̴̻̫͒͜͠͝t̴͎̝͕͑͒o̵̡̼̦̔̔̿",
    maxCapacity: 4,
    regularPrice: 400,
    discount: 390,
    image: imageUrl + "0.26190834456111844-4086a61ffe401ebd5a_The-Evil-Dead-1981-cabin-Delta-88-Oldsmobile.webp",
    description:
      "The Knowby Cabin has a large living room (where the trap door leading into the cellar is located), a kitchen, a bathroom, and three bedrooms.",
    deletable: "false",
  },
];
