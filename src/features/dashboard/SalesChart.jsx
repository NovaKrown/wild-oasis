...
function SalesChart({ bookings, numDays }) {
  ...
  const colors = isDarkMode
    ? {
        totalSales: { stroke: "#562c29", fill: "#ab5852" },
        extrasSales: { stroke: "#838469", fill: "#657268" },
        text: "#e5e7eb",
        background: "#18212f",
      }
    : {
        totalSales: { stroke: "#715660", fill: "#846470" },
        extrasSales: { stroke: "#667762", fill: "#879e82" },
        text: "#374151",
        background: "#fff",
      };
  return (
    <StyledSalesChart>
      <Heading as="h2">
        Sales: {format(allDates.at(0), "MMM dd yyyy")} &mdash; {format(allDates.at(-1), "MMM dd yyyy")}
      </Heading>
      ...
      <ResponsiveContainer height={300} width={"100%"}>
        <AreaChart data={data} margin={{ top: 10, right: 30, left: 30, bottom: 0 }}>
          ...
          <Tooltip contentStyle={{ backgroundColor: colors.background }} formatter={(value) => `$${value}`} />
          <Area
            dataKey="totalSales"
            type="monotone"
